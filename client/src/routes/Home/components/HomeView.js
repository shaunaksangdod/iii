    ...
    <div className='container'>
     <div className='row'>
      ...
      <div className='col-md-7 paddedDiv  main-content' style={{overflow: 'hidden', textAlign: 'left'}}>
       <h4 style={{fontWeight: '100', fontWeight: 300, fontFamily: 'Roboto', textAlign: 'justify'}}>
        The Immigrant Integration Index seeks to deepen understanding of the moderating effects of nativity status,
        race/ethnicity and
